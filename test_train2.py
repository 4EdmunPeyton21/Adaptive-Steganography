...
print("Testing with Capacity Map = 1.0 (Bypassing CamouflageNet)")
for i in range(101):
    ...
    if i % 20 == 0:
        print(f"Step {i:03d} | Ext Loss: {loss_ext.item():.4f} | Hide Loss: {loss_hide.item():.6f} | BER: {ber:.4f}")
